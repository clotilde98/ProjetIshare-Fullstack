...
const Posts = () => {
  ...
  const tableColumns = useMemo(
    () => [
      ...
      { title: "Description", width: 200, dataIndex: "description", key: "description", ellipsis: true },
      { title: "Places", width: 70, dataIndex: "numberOfPlaces", key: "numberOfPlaces" },
      {
        title: "Ville",
        dataIndex: "city",
        key: "city",
      ...
      >
        {mode === "delete" ? (
          ...
          <Form form={form} layout="vertical" onFinish={handleFormSubmit} initialValues={{ post_status: "available", selected_category_ids: [] }}>
            ...
            {mode !== "edit" && (
              <Form.Item name="client_id" label="Propriétaire (ID Client)" rules={[{ required: true, message: "Le propriétaire est requis" }]}>
